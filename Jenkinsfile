            ...
            stage ('Deployments'){
               parallel{
                    stage ('Deploy to Staging'){
                        steps {
                            bat "pscp -scp -i /users/dchuda/Downloads/test.pem "/Program Files (x86)/Jenkins/workspace/Fullyautomated/webapp/target/webapp.war" ec2-user@${params.tomcat_dev}:/var/lib/tomcat7/webapps"
                        }
                    }
